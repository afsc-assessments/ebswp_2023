...
sel_model <- c(rep("logistic",2), rep("age-specific",2))
...
Model | selectivity$model | No. Parameters --- | --- | --- Age-specific | "age-specific" | n_ages Logistic (increasing) | "logistic" | 2 Double logistic (dome) | "double-logistic" | 4 Logistic (decreasing) | "decreasing-logistic" | 2
