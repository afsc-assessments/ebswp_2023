...
In @fig-mod_index_fits_tuned and @fig-mod_bts_fit_tuned we show how the alternative tuning approaches affected the relative fits and uncertainty assumptions. For the observation-error tuning, the AVO error bars increased slightly while the opposite occurred for the ATS index.
