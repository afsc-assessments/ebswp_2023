...
#_          LO            HI          INIT         PRIOR         PR_SD       PR_type      PHASE    env-var    use_dev   dev_mnyr   dev_mxyr     dev_PH      Block    Blk_Fxn  #  parm_name
         -1002             3         -1000            -1          0.01             0         -2          0          0          0          0          0          0          0  #  AgeSel_P1_Fishery(1)
            ...
            -5             9           2.8            -1          0.01             0          2          0          0          0          0          0          0          0  #  AgeSel_P3_Fishery(1)
            -5             9           0.1            -1          0.01             0          2          0          0          0          0          0          0          0  #  AgeSel_P4_Fishery(1)
            -5             9           0.1            -1          0.01             0          2          0          0          0          0          0          0          0  #  AgeSel_P5_Fishery(1)
            -5             9           0.1            -1          0.01             0          2          0          0          0          0          0          0          0  #  AgeSel_P6_Fishery(1)
            -5             9             0            -1          0.01             0          2          0          0          0          0          0          0          0  #  AgeSel_P7_Fishery(1)
...
#_specs:  
#fleet, ymin,   ymax,   amin,  amax, sig_amax, use_rho, l1/a2, devphase, before_range, after_range
1       1991    2017    1       5       1       1       2       5        0             0    #  2d_AR specs for fleet: Fishery
# parameters for fleet 1:
#_LO    HI      INIT    PRIOR   PR_SD   PR_type PHASE  # parm_name
0.01    5       1.0     1.0     99      0       -5     # sigma_sel for fleet, age/size:  1 1
-0.8    0.8     0       0       99      0       -3     # rho_year for fleet:  1
-0.8    0.8     0       0       99      0       -3     # rho_age for fleet:  1
#
