if (doplots) {
  ...
  p1 <- plot_recruitment(modlst[c(1:3)], xlim = c(2000.5, 2022.5)) + ylab("")
  p1
  ...
  # "23.0")
  names(modlst)
  p1 <- plot_ssb(modlst[c(2:9)], xlim = c(2008.5, 2023.5), breaks = seq(2008, 2024, by = 2), alpha = .1)
  p1
  ...
  p1 <- plot_bts(modlst[c(3, 2)], xlim = c(1981.5, 2023.5), ylim = c(0, 15500))
  p1
  ...
  LY <- modlst[[2]]
  p1 <- plot_srr(modlst[c(1,3)], alpha = .2, xlim = c(0,4200), ylim = c(0, 85000), sizeout = 2, sizein = 4, yrsin = c(1977, 1979:2021))
  p1
