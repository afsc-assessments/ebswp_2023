...
void model_parameters::initializationfunction(void)
{
  ...
  log_K.set_initial_value(-0.116613588345);
 ...
 model_data(argc,argv) , function_minimizer(sz)
{
 ...
 MN_const = 1e-3; // Multinomial constant
  ...
  SRR_SSB.allocate(1,20,"SRR_SSB");
    ...
    SRR_SSB.initialize();
  #endif
  L1.allocate(10,50,1,"L1");
  L2.allocate(30,90,2,"L2");
  ...
  wt_pre.allocate(styr_wt,endyr_wt,age_st,age_end,"wt_pre");
    ...
    wt_pre.initialize();
  #endif
  mnwt.allocate(age_st,age_end,phase_d_scale,"mnwt");
