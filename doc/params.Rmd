# Parameter estimates for the EBS pollock reference model picked by the SSC (16.2, uses VAST full time series including Northern Bering Sea segment) 
\fontsize{7}{9}
