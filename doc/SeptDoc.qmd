...
Table 1 below shows the model evaluations examined, the naming convention used, and the relevant comparisons
and notes.
...
@tbl-modfitserr shows results on goodness of fits while
...
@tbl-modrefssb shows the impact of different spawning biomass weights-at-age assumptions.
