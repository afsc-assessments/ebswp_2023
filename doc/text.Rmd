...
assessment. Notably, a number of surveys were cancelled including the
 `r thisyr` NMFS bottom-trawl survey (BTS),
   the `r thisyr` NMFS acoustic-trawl survey (ATS), and 
   th `r thisyr` opportunistic acoustic data from vessels (AVO).  
...
#### Changes in the data
   ...
   3.  In summer `r thisyr`, the AFSC coordinated a survey conducted by three sailing drones (SD) using acoustics.
...
\hline
 ...
 EBS bottom trawl & Area-swept biomass and age-specific proportions & 1982--`r thisyr-1 ` \\ 
 ...
 Acoustic vessels of opportunity (AVO) & Biomass index & 2006--`r thisyr-1` \\
\hline
\end{tabular}
\end{table}
