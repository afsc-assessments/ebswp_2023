...
```{r  survfigs}
 ...
 printfig("at_age.png",i);i <- i + 1
 printfig("vastage.png",i);i <- i + 1 
 #17 figs...
```
```{r finfigs}
 printfig("fsh_wtage_strata.pdf",20)
 printfig("fsh_wtage_comb.pdf",21)
 ...
 printfig("N_comp.png",65)
 printfig("cum_N_wt.png",66)
...
# printfig("future_F.pdf",54)
 printfig("age_diversity.pdf",64)
 printfig("poll_cod_rec.png",70)
```
